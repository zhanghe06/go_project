...
func (m *MockOperationLogRepoInterface) GetList(filter map[string]interface{}) (int64, []*model.OperationLog, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOperationLogRepoInterfaceMockRecorder) GetList(filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetList", reflect.TypeOf((*MockOperationLogRepoInterface)(nil).GetList), filter)
}
